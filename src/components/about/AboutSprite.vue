...
onMounted(async () => {
    ...
    ctx = gsap.context(() => {
        // Centrage horizontal initial du personnage et de la corde
...
<template>
    <section ref="mainSection" class="w-full h-screen overflow-hidden bg-[#0C131B] relative flex z-10">

        <!-- ZONE VISUELLE (à gauche) -->
        <div class="w-1/2 h-full relative overflow-hidden">
            ...
            <div ref="islandsRef" class="absolute inset-0 w-full h-full z-20 pointer-events-none">
                ...
                <!-- Étape 1 : Commerce & Management (Ambre) -->
                <div ref="badge1" class="absolute pointer-events-auto" style="left: 4%; top: 38%;">
                    <div class="crystal-container group float-delay-1">
                        ...
                        <span class="tooltip">15 ans Commerce & Management</span>
                    </div>
                </div>

                <!-- Étape 2 : Reconversion & Stage (Émeraude) -->
                ...
                <!-- Étape 3 : Recherche d'opportunités (Saphir) -->
                ...
                <!-- Étape 4 : Lancement Freelance (Améthyste) -->
                <div ref="badge4" class="absolute pointer-events-auto" style="right: 2%; top: 30%;">
                    <div class="crystal-container group float-delay-4">
                        ...
                        <span class="tooltip">Aventure Freelance</span>
                    </div>
                </div>
            </div>
        ...
        <!-- ZONE TEXTE (à droite) -->
        <div class="w-1/2 h-full flex flex-col justify-center mt-5 p-8 space-y-20 z-40">

            <div ref="card1"
                class="group bg-slate-900/90 border-l-4 border-sky-400/70 border-y border-r border-slate-700 
                p-5 rounded-xl shadow-xl shadow-sky-500/5 hover:border-sky-400 hover:shadow-sky-500/20 hover:-translate-y-1 transition-all duration-300">
            ...
            <div ref="card2"
                class="group bg-slate-900/90 border-l-4 border-emerald-400/70 border-y border-r border-slate-700 
                p-5 rounded-xl shadow-xl shadow-emerald-500/5 hover:border-emerald-400 hover:shadow-emerald-500/20 hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center gap-3 mb-1">
                    <span
                ...
                <p class="text-slate-300 text-sm leading-relaxed mt-1">
                    J'aime créer des interfaces modernes, résoudre des problèmes concrets et apprendre continuellement de
                    nouvelles technologies. Chaque projet est l'occasion de progresser, d'explorer de nouvelles idées
                    ...
                    qu'à sa conception technique, afin de créer des solutions qui allient performance, simplicité et
                    créativité.
                </p>
            </div>

            <div ref="card3"
                class="group bg-slate-900/90 border-l-4 border-purple-400/70 border-y border-r border-slate-700 
                p-5 rounded-xl shadow-xl shadow-purple-500/5 hover:border-purple-400 hover:shadow-purple-500/20 hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center gap-3 mb-1">
                    <span
                ...
                <p class="text-slate-300 text-sm leading-relaxed mt-1">
                    ...
                    <br><br>
                    Chaque projet est une occasion de perfectionner mon code et de créerdes interfaces qui durent.
                </p>
            </div>
...
/* Décalages d'animation pour un mouvement naturel */
.float-delay-1 {
    animation-delay: 0s;
}
...
/* Styles du réceptacle de cristal */
.crystal {
    width: 48px;
    height: 48px;
    display: flex;
